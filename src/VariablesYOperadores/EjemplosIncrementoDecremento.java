...
public class EjemplosIncrementoDecremento {
    public static void main(String[] args) {
        ...
        // esto mismo lo podría a ver hecho así
        n++; // incrementa el valor de n en 1 - es lo mismo que n = n+1
        System.out.println("3. " + n);
        // otra forma de escribir eso mismo es
        n += 1; // esta nomeglantura vale también para el prducto (n += 1) etc...
        ...
        // si quiero que la variable disminuya en 1 unidad puedo hacerlo en dos formas
        n = n - 1;
        n--;
        n -= 1;
        --n;

...
public class EjemplosDecimales {
    public static void main(String[] args) {
       // Tipo double
        ...
        float decimalLargo = -3.123412412412414214124f;
        ...
        System.out.println("Multiplicación: " + (eps * n));
        System.out.println("División: " + (eps / n));
        // no tiene sentido hacer el % resto

        // ¿Que pasa si divido número enteros y los guardo en una variable con decimales?
        ...
        float decimalPorTeclado = sc.nextFloat(); // los número decimales por teclado se meten con ,

...
public class EjemplosOperadoresRelacionales {
    public static void main(String[] args) {
        // Sirven para compara dos números (normalmente) y dan como resultado un boolean
        ...
        3) Operaciones aritméticas (en el orden habitual: primero * y /, después + y -)
        ...
        // También comparamos si están en orden descendente
